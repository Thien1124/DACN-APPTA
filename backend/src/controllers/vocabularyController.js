...
// @desc    Lấy tất cả từ vựng (có thể lọc theo bài học)
...
exports.getVocabulary = asyncHandler(async (req, res, next) => {
  // **Hợp nhất logic:** Sử dụng nested populate để lấy thêm thông tin
...
// @desc    Tạo từ vựng mới cho một bài học
...
exports.createVocabulariesBulk = asyncHandler(async (req, res, next) => {
  ...
  // Thêm lessonId vào mỗi từ vựng để đảm bảo tính toàn vẹn
