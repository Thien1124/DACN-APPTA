...
const Home = () => {
  ...
  // ✅ Hàm kiểm tra đăng nhập và phân quyền
  const checkAuthAndRedirect = () => {
    ...
    if (isAuthenticated) {
      ...
      if (user?.role === 'admin') {
        ...
        navigate('/learn'); // User -> Learn page
      }
    ...
    <PageWrapper theme={theme}>
      ...
      <Navbar theme={theme} scrolled={isScrolled}>
        <NavContent>
          ...
          <NavLinks>
            <BtnSignIn onClick={handleLogin}>
              TÔI ĐÃ CÓ TÀI KHOẢN
            </BtnSignIn>
            <BtnGetStarted onClick={handleGetStarted}>
              BẮT ĐẦU
            </BtnGetStarted>
          </NavLinks>
        </NavContent>
      ...
      <HeroSection>
        <HeroContent>
          ...
          <HeroButtons>
            <BtnPrimary onClick={handleStartNow}>
              Bắt đầu ngay
            </BtnPrimary>
            <BtnSecondary theme={theme} onClick={handleLogin}>
              Tôi đã có tài khoản
            </BtnSecondary>
          </HeroButtons>
        </HeroContent>
      ...
      <CTASection>
        <CTACard>
          ...
          <CTAButton onClick={handleStartNow}>
            Bắt đầu miễn phí
          </CTAButton>
        </CTACard>
      </CTASection>
